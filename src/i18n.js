...
Youraccounthasbeencreatesuccessfully: "Your account has been created successfully",
...
Enteryouremailgetanewpassword: "Enter your email to get a new password",
...
Checkyouremailandchangethepassword: "Check your email and change the password",
ToLogin: "To Login",
...
Iagreetothetermsandconditions: "Tôi đồng ý với các điều khoản và điều kiện",
Alreadyhaveanaccount: "Đã có tài khoản",
Youraccounthasbeencreatesuccessfully: "Tài khoản của bạn đã được tạo thành công",
...
Enteryouremailgetanewpassword: "Nhập email của bạn để lấy mật khẩu mới",
...
Yourrequesthasbeensentsuccessfully: "Yêu cầu của bạn đã được gửi thành công",
foryournewpassword: "cho mật khẩu mới của bạn",
Checkyouremailandchangethepassword: "Kiểm tra email của bạn và đổi mật khẩu",
...
ChangePassword: "Thay đổi mật khẩu",
      ...
      ja: {
        translation: {
          ...
          Youraccounthasbeencreatesuccessfully: "アカウントが正常に作成されました",
Wehavealready: "すでに",
sentanemail: "メールを送信しました",
foryourpassword: "パスワードのために",
Loginandchangethepasswordagain: "ログインして再度パスワードを変更してください",
Enteryouremailgetanewpassword: "新しいパスワードを取得するにはメールを入力してください",
ForgotyourPassword: "パスワードを忘れましたか",
GetANewPassword: "新しいパスワードを取得",
Alreadyrememberyourpassword: "既にパスワードを覚えていますか",
Yourrequesthasbeensentsuccessfully: "リクエストが正常に送信されました",
foryournewpassword: "新しいパスワードのために",
Checkyouremailandchangethepassword: "メールを確認してパスワードを変更してください",
ToLogin: "ログインするには",
